import java.util.*; //Para usar o teclado
...
public class Principal {
	public static void main(String[] args){
		...
		//Criação da instância
		Vestuario lojaVestuario = new Vestuario("Loja Vestuário", 10, 2100, e1, d1, 20, false);
		...
		//Criação da instância
		Alimentacao lojaAlimentacao = new Alimentacao("Loja Alimentação", 10, 2100, e1, d1,5, d1);
		...
		//public void setEndereco(Endereco endereco)
		Endereco e2 = new Endereco("Rua das Flores", "15",null, "Porto Alegre", "RS", "Brasil", "91000-100");
    ...
    int menu;  //variável para opção do menu
	...
	switch(menu){
		...
		case 1:
		//criação da loja e entrada de dados
			Loja l1 = new Loja();

			System.out.println("Informe o nome da loja:");
			l1.setNome(teclado.next());
			System.out.println("Informe a quantidade de funcionários da loja:");
			l1.setQuantidadeFuncionarios(teclado.nextInt());
			System.out.println("Informe o salário base do funcionário:");
			l1.setSalarioBaseFuncionario(teclado.nextDouble());
			
			System.out.println("Informe o endereço:");
			System.out.println("Rua:");
			String nomeDaRua = teclado.next();
			...
			l1.setEndereco(new Endereco(nomeDaRua,numero,complemento,cidade, estado, pais, cep));

			System.out.println("Informe a data de fundação da loja:");
			l1.getDataFundacao().setDia(teclado.nextInt());
			System.out.println("Mês:");
			l1.getDataFundacao().setMes(teclado.nextInt());
			System.out.println("Ano:");
			l1.getDataFundacao().setAno(teclado.nextInt());
		...
		//criar produto
			...
			Produto produto1 = new Produto(nome, preco, new Data(dia,mes,ano));
